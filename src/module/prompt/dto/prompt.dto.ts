...
export class UpdatePromptDto {
  @ApiProperty({
    description: 'The master prompt text that will be used by the system. This can be a detailed instruction set for AI models to follow when generating questions or providing feedback. Supports multi-line text with markdown formatting and special characters. All characters are preserved exactly as sent.',
