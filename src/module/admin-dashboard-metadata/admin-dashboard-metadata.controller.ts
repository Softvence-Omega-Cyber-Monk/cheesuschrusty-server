...
export class AdminDashboardMetadataController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns key metrics, user growth, recent activity, and subscription breakdown',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Returns real-time analytics: active users, study time, content completion, retention, charts, and insights',
  })
  @ApiResponse({
    status: 200,
