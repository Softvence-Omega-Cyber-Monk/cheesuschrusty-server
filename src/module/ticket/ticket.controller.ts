...
export class TicketController {
  ...
  @ApiOperation({
    summary:
      'ADMIN: Get all tickets with optional status/priority filters and pagination.',
  })
  ...
  @Roles(Role.SUPER_ADMIN, Role.SUPORT_MANAGER)
  @ApiOperation({
    summary: 'ADMIN: Get ticket statistics/metadata for dashboard.',
  })
  ...
  @Roles(Role.SUPER_ADMIN, Role.SUPORT_MANAGER)
  @ApiOperation({
    summary: 'Update the status of a ticket (support staff only).',
  })
  @ApiParam({ name: 'id', description: 'Ticket ID' })
