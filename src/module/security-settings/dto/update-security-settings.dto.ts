...
export class UpdateSecuritySettingsDto {
  ...
  @ApiPropertyOptional({
    description: 'Max failed login attempts before temporary ban',
    example: 5,
  })
  @IsOptional()
  @IsInt()
  ...
  // -------------------------
  @ApiPropertyOptional({
    description: 'Enable automatic deletion of inactive user data',
    example: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Number of days before inactive user data is deleted',
    example: 365,
  })
  @IsOptional()
  @IsInt()
