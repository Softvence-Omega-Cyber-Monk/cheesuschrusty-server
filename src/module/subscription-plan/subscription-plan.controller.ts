...
export class SubscriptionPlansController {
  ...
  @Public()
  @ApiOperation({
    summary: 'PUBLIC: Get all active subscription plans for the pricing page.',
  })
  @ApiResponse({
    status: 200,
    description:
      'Returns a list of active plans (Monthly, Yearly) with pricing and features.',
  })
  ...
  @ApiParam({
    name: 'alias',
    description: 'The unique plan alias (e.g., PRO_MONTHLY or PRO_YEARLY).',
  })
